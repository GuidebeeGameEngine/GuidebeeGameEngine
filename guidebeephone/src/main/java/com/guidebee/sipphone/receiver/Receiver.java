...
public class Receiver extends BroadcastReceiver {
    ...
    public final static String EXTRA_DOCK_STATE = "android.intent.extra.DOCK_STATE";
    ...
    public final static String PAUSE_ACTION = "com.android.music.musicservicecommand.pause";
    public final static String TOGGLEPAUSE_ACTION = "com.android.music.musicservicecommand.togglepause";
    public final static String ACTION_DEVICE_IDLE = "com.android.server.WifiManager.action.DEVICE_IDLE";
    public final static String ACTION_VPN_CONNECTIVITY = "vpn.connectivity";
    public final static String ACTION_EXTERNAL_APPLICATIONS_AVAILABLE = "android.intent.action.EXTERNAL_APPLICATIONS_AVAILABLE";
    public final static String ACTION_EXTERNAL_APPLICATIONS_UNAVAILABLE = "android.intent.action.EXTERNAL_APPLICATIONS_UNAVAILABLE";
    public final static String METADATA_DOCK_HOME = "android.dock_home";
    public final static String CATEGORY_DESK_DOCK = "android.intent.category.DESK_DOCK";
    public final static String CATEGORY_CAR_DOCK = "android.intent.category.CAR_DOCK";
    public final static int EXTRA_DOCK_STATE_DESK = 1;
    public final static int EXTRA_DOCK_STATE_CAR = 2;
    ...
    static Intent createMWIIntent() {
        ...
        if (MWI_account != null)
            intent = new Intent(Intent.ACTION_CALL,
                    Uri.parse(MWI_account.replaceFirst("sip:", "sipdroid:")));
        else
