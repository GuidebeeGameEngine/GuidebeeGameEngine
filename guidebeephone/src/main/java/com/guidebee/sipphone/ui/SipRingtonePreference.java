...
{   
    ...
    protected void onSaveRingtone(Uri ringtoneUri) 
    {
		...
		edit.putString(com.guidebee.sipphone.ui.Settings.PREF_SIPRINGTONE, ringtoneUri != null ? ringtoneUri.toString() : com.guidebee.sipphone.ui.Settings.DEFAULT_SIPRINGTONE);
		edit.commit();        
    }
    ...
    {
        String uriString = PreferenceManager.getDefaultSharedPreferences(mContext).getString(com.guidebee.sipphone.ui.Settings.PREF_SIPRINGTONE,
