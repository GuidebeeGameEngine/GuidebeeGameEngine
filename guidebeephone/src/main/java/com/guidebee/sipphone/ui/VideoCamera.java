...
public class VideoCamera extends CallScreen implements 
    ...
    public void onStart() {
        ...
        videoQualityHigh = PreferenceManager.getDefaultSharedPreferences(mContext).getString(com.guidebee.sipphone.ui.Settings.PREF_VQUALITY, com.guidebee.sipphone.ui.Settings.DEFAULT_VQUALITY).equals("high");
    ...
    public void onResume() {
        ...
        if (!justplay) {
	        ...
	        startVideoRecording();
        } else if (Receiver.engine(mContext).getRemoteVideo() != 0 && PreferenceManager.getDefaultSharedPreferences(this).getString(com.guidebee.sipphone.ui.Settings.PREF_SERVER, com.guidebee.sipphone.ui.Settings.DEFAULT_SERVER).equals(com.guidebee.sipphone.ui.Settings.DEFAULT_SERVER)) {
