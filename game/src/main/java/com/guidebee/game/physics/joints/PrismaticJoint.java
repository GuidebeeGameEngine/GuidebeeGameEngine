 ...
 * an axis fixed in body1. Relative rotation is
 * prevented. You can use a joint limit to restrict the range of motion and a joint
 * motor to drive the motion or to model joint
 * friction.
 */
