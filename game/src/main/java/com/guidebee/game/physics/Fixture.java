...
import com.guidebee.game.physics.Shape.Type;
import com.guidebee.math.Vector2;

//[------------------------------ MAIN CLASS ----------------------------------]

/**
 * Box2D fixture wrapper.
 */
public class Fixture {
    ...
    /**
     * Get the type of the child shape. You can use this to down cast
    ...
    public Type getType() {
        ...
        switch (type) {
            ...
            case 3:
                return Type.Chain;
            default:
                throw new GameEngineRuntimeException("Unknown shape type!");
        }
    }
	...
	*/
    ...
    public Shape getShape() {
        if (shape == null) {
            ...
            if (shapeAddr == 0)
                throw new GameEngineRuntimeException("Null shape address!");
	...
	*/
     ...
     * time step when either parent body is active and
    ...
    private native void jniSetFilterData(long addr, short categoryBits,
...
// void GetMassData(b2MassData* massData) const;
     ...
     * the mass of the body. You must call
