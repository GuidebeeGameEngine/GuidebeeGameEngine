 ...
 * You can safely re-use body definitions. Shapes are added
...
public class BodyDef {
     ...
     * moved by solver dynamic: positive mass, non-zero velocity determined by
    ...
    /**
     * The body type: static, kinematic, or dynamic. Note: if a dynamic
     ...
     * through other moving bodies? Note that all bodies are
