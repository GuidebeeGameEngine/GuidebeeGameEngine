 ...
 * A typical usage is to control the movement of a
...
public class MotorJoint extends Joint {
	...
	*/
    ...
    private native void jniSetLinearOffset(long addr, float linearOffsetX,
                                           float linearOffsetY); /*
		b2MotorJoint* joint = (b2MotorJoint*)addr;
	...
	*/
    ...
    private native void jniSetCorrectionFactor(long addr,
