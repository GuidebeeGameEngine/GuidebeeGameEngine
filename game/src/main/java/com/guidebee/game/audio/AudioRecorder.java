 ...
 * sampling rate and is either stereo or mono. Samples are
 * returned in signed 16-bit PCM format. Stereo samples are interleaved in the
 * order left channel, right channel. The
...
public interface AudioRecorder extends Disposable {
     ...
     * If the recorder is in stereo you have to multiply
     * numSamples by 2.
     *
