 ...
 * signed short PCM data directly to the audio device.
 * Stereo samples are interleaved in the order left channel sample, right channel
 * sample. The {@link #dispose()} method must be
 * called when this IAudioDevice is no longer needed.
 *
 * @author badlogicgames@gmail.com
 */
public interface AudioDevice extends Disposable {
    /**
     * check whether this IAudioDevice is in mono or stereo mode.
     *
     * @return whether this IAudioDevice is in mono or stereo mode.
     */
    ...
    /**
     * Frees all resources associated with this IAudioDevice. Needs to be called
