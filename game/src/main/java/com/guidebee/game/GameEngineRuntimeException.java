...
/**
 * Typed runtime exception used throughout game engine.
 *
 * @author mzechner
 */
public class GameEngineRuntimeException extends RuntimeException {
     ...
     * @param t
     */
    public GameEngineRuntimeException(Throwable t) {
        super(t);
    }
     ...
     * @param t
     */
    public GameEngineRuntimeException(String message, Throwable t) {
        super(message, t);
    }
}
