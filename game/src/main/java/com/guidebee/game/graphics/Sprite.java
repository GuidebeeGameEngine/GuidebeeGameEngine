 ...
 * {@link Batch}. A Sprite has a position and a
 * size given as width and height. The position is relative to the origin of the
 * coordinate system specified via
 * {@link Batch#begin()} and the respective matrices. A Sprite is always rectangular
 * and its position (x, y) are located in the
 * bottom left corner of that rectangle. A Sprite also has an origin around which
 * rotations and scaling are performed (that is,
 * the origin is not modified by rotation and scaling). The origin is given relative
 * to the bottom left corner of the Sprite, its
 * position.
 *
 * @author mzechner
 * @author Nathan Sweet
...
public class Sprite extends TextureRegion {
    ...
    /**
     * Creates a sprite with width, height, and texture region equal to the
     * specified size. The texture region's upper left corner
     * will be 0,0.
     *
     * @param srcWidth  The width of the texture region. May be negative to
    ...
    /**
     * Creates a sprite with width, height, and texture region equal to
     * the specified size.
     *
     * @param srcWidth  The width of the texture region. May be negative
     *                  to flip the sprite when drawn.
     * @param srcHeight The height of the texture region. May be negative
     *                  to flip the sprite when drawn.
     */
     ...
     * region is a copy of the parameter region - altering one
    ...
    /**
     * Creates a sprite with width, height, and texture region equal to
     * the specified size, relative to specified sprite's texture
     * region.
     *
     * @param srcWidth  The width of the texture region. May be negative
     *                  to flip the sprite when drawn.
     ...
     * and rotation are applied. If origin, rotation, or scale
     * are changed, it is slightly more efficient to set the bounds
    ...
    /**
     * Sets the size of the sprite when drawn, before scaling and
     * rotation are applied. If origin, rotation, or scale are changed,
     * it is slightly more efficient to set the size after those
     * operations. If both position and size are to be changed, it is
    ...
    /**
     * Sets the position where the sprite will be drawn. If origin,
     * rotation, or scale are changed, it is slightly more efficient
     * to set the position after those operations. If both position
    ...
    /**
     * Sets the x position where the sprite will be drawn. If origin,
     * rotation, or scale are changed, it is slightly more efficient
     * to set the position after those operations. If both position
     * and size are to be changed, it is better to use
     * {@link #setBounds(float, float, float, float)}.
    ...
    /**
     * Sets the y position where the sprite will be drawn. If origin,
     * rotation, or scale are changed, it is slightly more efficient
     * to set the position after those operations. If both position
     * and size are to be changed, it is better to use
     * {@link #setBounds(float, float, float, float)}.
    ...
    /**
     * Sets the x position relative to the current position where the
     * sprite will be drawn. If origin, rotation, or scale are
    ...
    /**
     * Sets the y position relative to the current position where the
     * sprite will be drawn. If origin, rotation, or scale are
     * changed, it is slightly more efficient to translate after those operations.
     */
    ...
    /**
     * Sets the position relative to the current position where the
     * sprite will be drawn. If origin, rotation, or scale are
     * changed, it is slightly more efficient to translate after
     * those operations.
     */
    ...
    public void setAlpha(float a) {
        int intBits = NumberUtils.floatToIntColor(vertices[Batch.C1]);
    ...
    /**
     * Sets the rotation of the sprite in degrees. Rotation is
     * centered on the origin set in {@link #setOrigin(float, float)}
     */
     ...
     * coordinates. This rotation is unaffected by
    ...
    /**
     * Sets the sprite's scale for both X and Y. The sprite scales out
    ...
    /**
     * Sets the sprite's scale relative to the current scale. for
     * example: original scale 2 -> sprite.scale(4) -> final scale 6.
     * The sprite scales out from the origin. This will not affect
     * the values returned by {@link #getWidth()} and
     * {@link #getHeight()}
     */
    ...
    /**
     * Returns the bounding axis aligned {@link Rectangle} that bounds
     * this sprite. The rectangles x and y coordinates describe its
     * bottom left corner. If you change the position or size of the
     * sprite, you have to fetch the triangle again for it to be
     * recomputed.
     *
    ...
    /**
     * Returns the color of this sprite. Changing the returned color
     * will have no affect, {@link #setColor(Color)} or
