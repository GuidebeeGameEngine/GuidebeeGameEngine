...
public class PolygonRegion {
    ...
    /**
     * Creates a PolygonRegion by triangulating the polygon coordinates in
     * vertices and calculates uvs based on that. TextureRegion
     * can come from an atlas.
     *
     * @param region   the region used for drawing
     * @param vertices contains 2D polygon coordinates in pixels relative
     *                 to source region
     */
