 ...
 * [0,1]. All methods perform clamping on the
...
public class Color {
     ...
     * in the range [0,1]. The result is stored in this
     * color.
     *
    ...
    /**
     * Packs the color components into a 32-bit integer with the format
     * ABGR and then converts it to a float.
     *
     * @return the packed color as a 32-bit float
     * @see NumberUtils#intToFloatColor(int)
     */
    ...
    /**
     * Packs the color components into a 32-bit integer with the format ABGR.
     * Note that no range checking is performed for higher
     * performance.
     *
     * @param r the red component, 0 - 255
     * @param g the green component, 0 - 255
    ...
    public static int rgb565(Color color) {
        return ((int) (color.r * 31) << 11)
                | ((int) (color.g * 63) << 5) | (int) (color.b * 31);
    }
     ...
     * RGB565. This is inverse to the rgb565(r, g, b)
     * method.
     *
    ...
    /**
     * Sets the Color components using the specified integer value in the format
     * RGBA4444. This is inverse to the rgba4444(r, g, b,
     * a) method.
     *
     * @param color The Color to be modified.
    ...
    /**
     * Sets the Color components using the specified integer value in the format
     * RGB888. This is inverse to the rgb888(r, g, b)
     * method.
     *
     * @param color The Color to be modified.
    ...
    /**
     * Sets the Color components using the specified integer value in the format
     * RGBA8888. This is inverse to the rgba8888(r, g, b,
     * a) method.
     *
     * @param color The Color to be modified.
    ...
    /**
     * Returns a temporary copy of this color. This is not thread safe, do
     * not save a reference to this instance.
     *
