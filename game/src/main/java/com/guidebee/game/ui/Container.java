 ...
 * constraints. This provides layout similar to a
...
public class Container<T extends Actor> extends WidgetGroup {
    ...
    private Value padTop = Value.zero, padLeft = Value.zero,
            padBottom = Value.zero, padRight = Value.zero;
    ...
    /**
     * Sets the background drawable and adjusts the container's padding
    ...
    /**
     * Sets the background drawable and, if adjustPadding is true,
     * sets the container's padding to
     * {@link Drawable#getBottomHeight()} , {@link Drawable#getTopHeight()},
     * {@link Drawable#getLeftWidth()}, and
    ...
    public void drawDebug(ShapeRenderer shapes) {
        ...
        if (isTransform()) {
            ...
            if (clip) {
                ...
                float padLeft = this.padLeft.get(this),
                        padBottom = this.padBottom.get(this);
                boolean draw = background == null ? clipBegin(0, 0, getWidth(),
                        getHeight()) : clipBegin(padLeft, padBottom,
                        getWidth() - padLeft - padRight.get(this),
                        getHeight() - padBottom - padTop.get(this));
                if (draw) {
