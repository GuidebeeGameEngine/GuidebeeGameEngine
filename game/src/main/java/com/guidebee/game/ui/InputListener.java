...
/**
 * EventListener for low-level input events. Unpacks {@link InputEvent}s and calls
 * the appropriate method. By default the methods
 * here do nothing with the event. Users are expected to override the methods they
 ...
 * 		GameEngine.app.log(&quot;Example&quot;, &quot;touch done at (&quot; + x + &quot;,
 * 		&quot; + y + &quot;)&quot;);
 *    }
 * });
 * </pre>
...
public class InputListener implements EventListener {
    ...
    public boolean handle(Event e) {
        ...
        switch (event.getType()) {
            case touchDown:
                return touchDown(event, tmpCoords.x, tmpCoords.y,
                        event.getPointer(), event.getButton());
            case touchUp:
                touchUp(event, tmpCoords.x, tmpCoords.y,
                        event.getPointer(), event.getButton());
                return true;
            case touchDragged:
            ...
            case scrolled:
                return scrolled(event, tmpCoords.x, tmpCoords.y,
     ...
     * if touchDown previously returned true for the mouse
     ...
     * touchDown previously returned true for the mouse
     ...
     * occurs on the desktop. When true is returned,
    ...
    /**
     * Called when a key goes down. When true is returned, the event
