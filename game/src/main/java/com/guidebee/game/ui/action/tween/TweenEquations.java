 ...
 ******************************************************************************/
//--------------------------------- PACKAGE ------------------------------------
package com.guidebee.game.ui.action.tween;

//--------------------------------- IMPORTS ------------------------------------

import com.guidebee.game.ui.action.tween.equations.Back;
import com.guidebee.game.ui.action.tween.equations.Bounce;
import com.guidebee.game.ui.action.tween.equations.Circ;
import com.guidebee.game.ui.action.tween.equations.Cubic;
import com.guidebee.game.ui.action.tween.equations.Elastic;
import com.guidebee.game.ui.action.tween.equations.Expo;
import com.guidebee.game.ui.action.tween.equations.Linear;
import com.guidebee.game.ui.action.tween.equations.Quad;
import com.guidebee.game.ui.action.tween.equations.Quart;
import com.guidebee.game.ui.action.tween.equations.Quint;
import com.guidebee.game.ui.action.tween.equations.Sine;
