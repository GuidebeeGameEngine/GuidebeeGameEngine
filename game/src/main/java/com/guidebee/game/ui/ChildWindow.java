 ...
 * the children as laid out by the table. After adding
 * children to the window, it can be convenient to call {@link #pack()} to size
 * the window to the size of the children.
 *
 * @author Nathan Sweet
 */
public class ChildWindow extends Table {
    ...
    public ChildWindow(String title, Skin skin, String styleName) {
        this(title, skin.get(styleName, WindowStyle.class));
        setSkin(skin);
    }

    public ChildWindow(String title, WindowStyle style) {
        if (title == null)
     ...
     * effect until {@link #setStyle(WindowStyle)} is
     * called.
     */
    ...
    protected void drawBackground(Batch batch, float parentAlpha, float x, float y) {
        ...
        buttonTable.pack();
        buttonTable.setPosition(width - buttonTable.getWidth(), Math.min(height - padTop,
                height - buttonTable.getHeight()));
    ...
    /**
     * The style for a window, see {@link ChildWindow}.
     *
     * @author Nathan Sweet
     */
