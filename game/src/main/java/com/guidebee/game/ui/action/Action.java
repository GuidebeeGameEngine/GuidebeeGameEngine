...
abstract public class Action implements Pool.Poolable {
     ...
     * be called after the action is done.
     */
     ...
     * {@link com.guidebee.game.ui.action.DelayAction delayed}.
     * The actor's state is best queried in the first call to
     * {@link #act(float)}. For a
     * {@link com.guidebee.game.ui.action.TemporalAction},
    ...
    /**
     * Resets the optional state of this action to as if it were newly
     * created, allowing the action to be pooled and reused. State
     * required to be set for every usage of this action or computed
