...
public class ClickListener extends InputListener {
    ...
    /**
     * Create a listener where {@link #clicked(InputEvent, float, float)}
    ...
    /**
     * If a touch down is being monitored, the drag and touch up
     * events are ignored until the next touch up.
     */
    public void cancel() {
    ...
    public boolean isVisualPressed() {
        ...
        if (visualPressedTime > TimeUtils.nanoTime()
                && GameEngine.graphics.isContinuousRendering()) return true;
        visualPressedTime = 0;
        return false;
    }
    ...
    /**
     * Returns the number of taps within the tap count interval for the most
     * recent click event.
     */
    ...
    /**
     * The button that initially pressed this button or -1 if the button
     * is not pressed.
     */
    ...
    /**
     * The pointer that initially pressed this button or -1 if the button
     * is not pressed.
     */
     ...
     * is {@link Buttons#LEFT}. Use -1 for any button.
     */
