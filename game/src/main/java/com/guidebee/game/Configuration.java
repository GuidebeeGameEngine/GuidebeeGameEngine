...
/**
 * Class defining the configuration of an {@link com.guidebee.game.Application}.
 * Allows you to disable the use of the accelerometer to save
 * battery among other things and other settings.
 *
 * @author mzechner
 */
public class Configuration {
    ...
    /**
     * whether to keep the screen on and at full brightness or not while
     * running the application. default: false
     */
    public boolean useWakelock = false;

    /**
     * hide status bar buttons on Android 4.x and higher (API 14+).
     * Doesn't work if "android:targetSdkVersion" less 11 or if API
    ...
    /**
     * the maximum number of {@link com.guidebee.game.audio.Sound}
     * instances that can be played simultaneously, sets the corresponding
     * {@link SoundPool}
