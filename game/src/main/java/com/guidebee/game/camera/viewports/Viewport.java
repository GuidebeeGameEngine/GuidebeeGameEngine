...
/**
 * Manages a {@link com.guidebee.game.camera.Camera} and determines
 * how world coordinates are mapped to and from the screen.
 *
...
public abstract class Viewport {
     ...
     *
     * @param centerCamera If true, the camera position is set to
     *                     the center of the world.
     */
    public void apply(boolean centerCamera) {
        GameEngine.gl.glViewport(screenX, screenY, screenWidth, screenHeight);
     ...
     * size and calls {@link #apply(boolean)}. Typically called
     * from {@link ApplicationListener#resize(int, int)}
     * or {@link com.guidebee.game.Screen#resize(int, int)}.
     * <p/>
     ...
     * com.guidebee.math.Matrix4, Rectangle, Rectangle)
     */
    public void calculateScissors(Matrix4 batchTransform, Rectangle area,
                                  Rectangle scissor) {
     ...
     * window coordinates), where the origin is in the top
    ...
    public Vector2 toScreenCoordinates(Vector2 worldCoords, Matrix4 transformMatrix) {
        ...
        camera.project(tmp);
        tmp.y = GameEngine.graphics.getHeight() - tmp.y;
        worldCoords.x = tmp.x;
        worldCoords.y = tmp.y;
        return worldCoords;
    }
    ...
    /**
     * The virtual width of this viewport in world coordinates. This width
     * is scaled to the viewport's screen width.
     */
    ...
    /**
     * The virtual height of this viewport in world coordinates. This height
     * is scaled to the viewport's screen height.
     */
    ...
    /**
     * get screen x (from left edge of the screen)
     * @return
     */
    ...
    /**
     * get offset from the bottom edge of the screen.
     * @return offset from the bottom edge of the screen
     */
    ...
    /**
     * Sets the viewport's width in screen coordinates. This is typically
     * set by {@link #update(int, int, boolean)}.
     */
    ...
    /**
     * Sets the viewport's height in screen coordinates. This is typically
     * set by {@link #update(int, int, boolean)}.
     */
    ...
    /**
     * Sets the viewport's position in screen coordinates. This is typically
     * set by {@link #update(int, int, boolean)}.
     */
    ...
    /**
     * Sets the viewport's size in screen coordinates. This is typically
     * set by {@link #update(int, int, boolean)}.
     */
    ...
    /**
     * Sets the viewport's bounds in screen coordinates. This is typically
     * set by {@link #update(int, int, boolean)}.
     */
    ...
    public int getRightGutterWidth() {
        return GameEngine.graphics.getWidth() - (screenX + screenWidth);
    }
    ...
    public int getTopGutterHeight() {
        return GameEngine.graphics.getHeight() - (screenY + screenHeight);
    }
}
