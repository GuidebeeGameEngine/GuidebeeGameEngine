...
/**
 * A ScalingViewport that uses {@link com.guidebee.utils.Scaling#stretch}
 * so it does not keep the aspect ratio, the world is scaled to take the whole
 * screen.
 *
...
public class StretchViewport extends ScalingViewport {
    /**
     * Creates a new viewport using
     * a new {@link com.guidebee.game.camera.OrthographicCamera}.
     */
