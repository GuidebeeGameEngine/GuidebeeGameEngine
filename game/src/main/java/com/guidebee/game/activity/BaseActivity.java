...
/**
 * Interface that abstracts the Android application class usages, so that
 * GameEngine can be used with a fragment (or with any other
 * client code)
 *
 * @author Bartol Karuza (me@bartolkaruza.com)
 * @author davebaol
 */
public interface BaseActivity extends Application {
    ...
    /**
     * Method signifies an intent of the caller to execute
     * some action on the UI Thread.
     *
    ...
    /**
     * Method signifies an intent to start an activity, may be
     * the default method of the {@link Activity} class
     *
    ...
    /**
     * Returns the {@link com.guidebee.game.engine.platform.Input} object associated with this {@link BaseActivity}
     *
     * @return the {@link com.guidebee.game.engine.platform.Input} object
     */
    @Override
    Input getInput();

    /**
     * Returns the {@link LifecycleListener} array associated
     * with this {@link BaseActivity}
     *
