 ...
 * keep screens around or dispose of them when another
 * screen is set.
 * </p>
 */
public abstract class GamePlay implements ApplicationListener {
    ...
    public void render() {
        if (screen != null)
            screen.render(GameEngine.graphics.getDeltaTime());
    }
    ...
    public void setScreen(Screen screen) {
        ...
        if (this.screen != null) {
            this.screen.show();
            this.screen.resize(GameEngine.graphics.getWidth(),
