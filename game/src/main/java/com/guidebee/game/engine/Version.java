 ...
 ******************************************************************************/
//--------------------------------- PACKAGE ------------------------------------
package com.guidebee.game.engine;
...
//[------------------------------ MAIN CLASS ----------------------------------]
/**
 * The version of gameengine
 *
 * @author mzechner
 */
public class Version {
    /**
     * the current version of gameengine as a String in the major.minor.revision format *
     */
    public static final String VERSION = "1.0.0";

    /**
     * the current major version of gameengine *
     */
    public static final int MAJOR;

    /**
     * the current minor version of gameengine *
     */
    public static final int MINOR;

    /**
     * the current revision version of gameengine *
     */
    ...
    static {
        try {
            ...
            // Should never happen
            throw new GameEngineRuntimeException("Invalid version " + VERSION, t);
        }
    }
