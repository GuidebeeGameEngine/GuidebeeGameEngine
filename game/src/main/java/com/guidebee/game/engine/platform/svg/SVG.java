...
public class SVG {
    ...
    public int []getRGB(int width,int height){
        try {
            setDocumentViewBox(0, 0, getDocumentWidth(), getDocumentHeight());
            ...
            renderToCanvas(bmcanvas);

            IntBuffer buffer= IntBuffer.allocate(newBM.getWidth() * newBM.getHeight());
            ...
            throw new GameEngineRuntimeException("Cannot get RGB "+e.getMessage());
        }
