 ...
 * to load parts of an OpenGL resource, like the
 * Pixmap, on a separate thread to then load the actual resource on the thread the
 * OpenGL context is active on.
 *
 * @param <T>
 * @param <P>
 * @author mzechner
...
public abstract class AsynchronousAssetLoader<T, P extends AssetLoaderParameters<T>>
     ...
     */
    public abstract void loadAsync(AssetManager manager, String fileName,
                                   FileHandle file, P parameter);
     ...
     * @param parameter
     */
    public abstract T loadSync(AssetManager manager, String fileName,
                               FileHandle file, P parameter);
}
