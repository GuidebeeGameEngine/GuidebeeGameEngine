 ...
 * <p>
 * <p>
 * If the OpenGL ES context was lost you can call {@link #invalidate()}
 ...
 * <p>
 * <p>
 * VertexBufferObjects must be disposed via the {@link #dispose()} method
...
public class VertexBufferObject implements VertexData {
    ...
    private void bufferChanged() {
        if (isBound) {
            GameEngine.gl20.glBufferData(IGL20.GL_ARRAY_BUFFER, byteBuffer.limit(),
                    byteBuffer, usage);
            isDirty = false;
        }
    }
