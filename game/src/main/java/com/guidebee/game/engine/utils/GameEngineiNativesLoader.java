...
//[------------------------------ MAIN CLASS ----------------------------------]
public class GameEngineiNativesLoader {
    static public boolean disableNativesLoading = false;

    static private boolean nativesLoaded;

    /**
     * Loads the libgameengine native libraries if they have not already been loaded.
     */
    static public synchronized void load() {
        ...
        new SharedLibraryLoader().load("gameengine");
    }
}
