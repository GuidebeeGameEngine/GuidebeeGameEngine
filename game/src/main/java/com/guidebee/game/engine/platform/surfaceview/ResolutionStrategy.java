...
//[------------------------------ MAIN CLASS ----------------------------------]
/**
 * Will manipulate the GLSurfaceView. Gravity is always center. The width and
 * height of the View will be determined by the
...
public interface ResolutionStrategy {
    ...
    public MeasuredDimension calcMeasures(final int widthMeasureSpec,
