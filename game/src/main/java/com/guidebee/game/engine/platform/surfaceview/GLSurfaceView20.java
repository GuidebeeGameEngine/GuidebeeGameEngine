...
//[------------------------------ MAIN CLASS ----------------------------------]
/**
 * A simple GLSurfaceView sub-class that demonstrates how to perform
 * OpenGL ES 2.0 rendering into a GL Surface. Note the following
 * important details:
 * <p/>
...
public class GLSurfaceView20 extends GLSurfaceView {
    ...
    public InputConnection onCreateInputConnection(EditorInfo outAttrs) {
        ...
        // add this line, the IME can show the selectable words when
        // use chinese input method editor.
        if (outAttrs != null) {
        ...
        BaseInputConnection connection = new BaseInputConnection(this, false) {
            ...
            private void sendDownUpKeyEventForBackwardCompatibility(final int code) {
                ...
                super.sendKeyEvent(new KeyEvent(SystemClock.uptimeMillis(), eventTime,
                        KeyEvent.ACTION_UP, code, 0, 0,
                        KeyCharacterMap.VIRTUAL_KEYBOARD, 0,
                        KeyEvent.FLAG_SOFT_KEYBOARD | KeyEvent.FLAG_KEEP_TOUCH_MODE));
            }
        };
    ...
    private void init(boolean translucent, int depth, int stencil) {
		 ...
		 * surface's format here, using PixelFormat.TRANSLUCENT for GL Surfaces
    ...
    private static class ConfigChooser implements GLSurfaceView.EGLConfigChooser {
        ...
        public EGLConfig chooseConfig(EGL10 egl, EGLDisplay display, EGLConfig[] configs) {
            for (EGLConfig config : configs) {
                ...
                if (r == mRedSize && g == mGreenSize
                        && b == mBlueSize && a == mAlphaSize) return config;
            }
            return null;
        }
        ...
        private void printConfig(EGL10 egl, EGLDisplay display, EGLConfig config) {
            int[] attributes = {EGL10.EGL_BUFFER_SIZE, EGL10.EGL_ALPHA_SIZE,
                    ...
                    EGL10.EGL_RED_SIZE, EGL10.EGL_DEPTH_SIZE,
