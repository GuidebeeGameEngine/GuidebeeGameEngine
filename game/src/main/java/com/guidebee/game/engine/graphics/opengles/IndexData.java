...
//[------------------------------ MAIN CLASS ----------------------------------]
/**
 * An IndexData instance holds index data. Can be either a plain short buffer
 * or an OpenGL buffer object.
 *
 * @author mzechner
 */
public interface IndexData extends Disposable {
    ...
    /**
     * Invalidates the IndexBufferObject so a new OpenGL buffer
     * handle is created. Use this in case of a context loss.
     */
