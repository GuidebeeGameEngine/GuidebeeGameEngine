 ...
 */
public class GL30Profiler extends GLProfiler implements IGL30 {

    public IGL30 gl30;

    protected GL30Profiler(IGL30 gl30) {
        this.gl30 = gl30;
    }
    ...
    public void glCompressedTexImage2D(int target, int level, int internalformat,
        ...
        calls++;
        gl30.glCompressedTexImage2D(target, level, internalformat, width, height,
    ...
    public void glCompressedTexSubImage2D(int target, int level, int xoffset,
                                          ...
                                          int imageSize, Buffer data) {
        calls++;
        gl30.glCompressedTexSubImage2D(target, level, xoffset, yoffset, width,
    ...
    public void glCopyTexImage2D(int target, int level, int internalformat,
        ...
        calls++;
        gl30.glCopyTexImage2D(target, level, internalformat, x, y, width,
                height, border);
    }
    ...
    public void glCopyTexSubImage2D(int target, int level, int xoffset,
        ...
        calls++;
        gl30.glCopyTexSubImage2D(target, level, xoffset, yoffset, x, y,
                width, height);
    }
    ...
    public void glTexImage2D(int target, int level, int internalformat,
                             ...
                             Buffer pixels) {
        calls++;
        gl30.glTexImage2D(target, level, internalformat, width, height,
    ...
    public void glTexSubImage2D(int target, int level, int xoffset, int yoffset,
                                ...
                                Buffer pixels) {
        calls++;
        gl30.glTexSubImage2D(target, level, xoffset, yoffset, width, height,
                format, type, pixels);
    }
    ...
    public void glFramebufferRenderbuffer(int target, int attachment,
        ...
        calls++;
        gl30.glFramebufferRenderbuffer(target, attachment,
    ...
    public void glFramebufferTexture2D(int target, int attachment,
        ...
        calls++;
        gl30.glFramebufferTexture2D(target, attachment, textarget,
                texture, level);
    }
    ...
    public void glTexImage3D(int target, int level, int internalformat,
                             ...
                             int type, Buffer pixels) {
        calls++;
        gl30.glTexImage3D(target, level, internalformat, width, height,
    ...
    public void glTexSubImage3D(int target, int level, int xoffset,
        ...
        calls++;
        gl30.glTexSubImage3D(target, level, xoffset, yoffset, zoffset,
    ...
    public void glBlitFramebuffer(int srcX0, int srcY0, int srcX1, int srcY1,
                                  ...
                                  int mask, int filter) {
        calls++;
        gl30.glBlitFramebuffer(srcX0, srcY0, srcX1, srcY1, dstX0, dstY0,
    ...
    public void glRenderbufferStorageMultisample(int target, int samples,
        ...
        calls++;
        gl30.glRenderbufferStorageMultisample(target, samples,
    ...
    public void glCopyBufferSubData(int readTarget, int writeTarget,
        ...
        calls++;
        gl30.glCopyBufferSubData(readTarget, writeTarget, readOffset,
                writeOffset, size);
    }
    ...
    public void glInvalidateSubFramebuffer(int target, int numAttachments,
                                           ...
                                           int height) {
        calls++;
        gl30.glInvalidateSubFramebuffer(target, numAttachments,
