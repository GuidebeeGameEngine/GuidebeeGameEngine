...
public abstract class AssetLoader<T, P extends AssetLoaderParameters<T>> {
    ...
    /**
     * Constructor, sets the {@link FileHandleResolver} to use to resolve
     ...
     * @return handle to the file, as resolved by the
     * {@link FileHandleResolver} set on the loader
     */
     ...
     * @return other assets that the asset depends on and need to
     * be loaded first or null if there are no dependencies.
     */
