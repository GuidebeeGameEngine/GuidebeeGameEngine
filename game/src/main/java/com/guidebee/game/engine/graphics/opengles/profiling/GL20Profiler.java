 ...
 */
public class GL20Profiler extends GLProfiler implements IGL20 {

    public IGL20 gl20;

    protected GL20Profiler(IGL20 gl20) {
        this.gl20 = gl20;
    }
    ...
    public void glCompressedTexImage2D(int target, int level, int internalformat,
        ...
        calls++;
        gl20.glCompressedTexImage2D(target, level, internalformat, width, height,
    ...
    public void glCompressedTexSubImage2D(int target, int level, int xoffset,
                                          ...
                                          int imageSize, Buffer data) {
        calls++;
        gl20.glCompressedTexSubImage2D(target, level, xoffset, yoffset, width,
    ...
    public void glCopyTexImage2D(int target, int level, int internalformat,
        ...
        calls++;
        gl20.glCopyTexImage2D(target, level, internalformat, x, y,
                width, height, border);
    }
    ...
    public void glTexImage2D(int target, int level, int internalformat,
                             ...
                             Buffer pixels) {
        calls++;
        gl20.glTexImage2D(target, level, internalformat, width, height,
    ...
    public void glTexSubImage2D(int target, int level, int xoffset,
                                ...
                                Buffer pixels) {
        calls++;
        gl20.glTexSubImage2D(target, level, xoffset, yoffset, width,
    ...
    public void glFramebufferRenderbuffer(int target, int attachment,
        ...
        calls++;
        gl20.glFramebufferRenderbuffer(target, attachment,
    ...
    public void glFramebufferTexture2D(int target, int attachment,
        ...
        calls++;
        gl20.glFramebufferTexture2D(target, attachment,
