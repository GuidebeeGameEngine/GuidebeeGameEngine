...
//[------------------------------ MAIN CLASS ----------------------------------]
/**
 * {@link AssetLoader} for {@link com.guidebee.game.graphics.Pixmap}
 * instances. The Pixmap is loaded asynchronously.
 *
 * @author mzechner
 */
public class PixmapLoader extends AsynchronousAssetLoader<Pixmap,
    ...
    @Override
    public Pixmap loadSync(AssetManager manager, String fileName,
                           FileHandle file, PixmapParameter parameter) {
