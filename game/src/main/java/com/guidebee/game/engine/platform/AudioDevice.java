...
//[------------------------------ MAIN CLASS ----------------------------------]
/**
 * Implementation of the {@link com.guidebee.game.audio.AudioDevice}
 * interface for Android using the AudioTrack class. You will need to set the permission
 * android.permission.RECORD_AUDIO in your manifest file.
 *
 * @author mzechner
 */
class AudioDevice implements com.guidebee.game.audio.AudioDevice {
    /**
     * the audio track *
     */
    ...
    public void writeSamples(short[] samples, int offset, int numSamples) {
        ...
        while (writtenSamples != numSamples)
            writtenSamples += track.write(samples, offset + writtenSamples,
    ...
    public void writeSamples(float[] samples, int offset, int numSamples) {
        ...
        while (writtenSamples != numSamples)
            writtenSamples += track.write(buffer, writtenSamples,
                    numSamples - writtenSamples);
    }
