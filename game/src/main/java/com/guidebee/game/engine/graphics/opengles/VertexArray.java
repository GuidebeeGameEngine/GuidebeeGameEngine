 ...
 * data in the order you specified in the constructor
 * via {@link com.guidebee.game.engine.graphics.VertexAttribute}.
 * </p>
 * <p>
 * <p>
 * This class does not support shaders and for that matter OpenGL ES 2.0.
 * For this {@link VertexBufferObject}s are needed.
 * </p>
 *
...
public class VertexArray implements VertexData {
    ...
    public VertexArray(int numVertices, VertexAttributes attributes) {
        ...
        byteBuffer = BufferUtils.newUnsafeByteBuffer(this.attributes.vertexSize
                * numVertices);
