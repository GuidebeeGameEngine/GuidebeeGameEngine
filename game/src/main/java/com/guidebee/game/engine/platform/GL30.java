...
//[------------------------------ MAIN CLASS ----------------------------------]
public class GL30 extends GL20 implements IGL30 {
    @Override
    ...
    public void glTexSubImage3D(int target, int level, int xoffset,
        ...
        GLES30.glTexSubImage3D(target, level, xoffset, yoffset,
...
// int width, int height, int depth, int border, int
...
// GLES30.glCompressedTexImage3D(target, level, internalformat,
// width, height, depth, border, imageSize, offset);
// }
//
// @Override
// public void glCompressedTexSubImage3D(int target, int level, int xoffset,
// int yoffset, int zoffset, int width, int height, int
// depth, int format, int imageSize, java.nio.Buffer data) {
// GLES30.glCompressedTexSubImage3D(target, level, xoffset, yoffset, zoffset,
...
// }
    ...
    public void glBlitFramebuffer(int srcX0, int srcY0, int srcX1,
                                  ...
                                  int dstX1, int dstY1,
                                  int mask, int filter) {
        GLES30.glBlitFramebuffer(srcX0, srcY0, srcX1, srcY1, dstX0,
    ...
    public void glFramebufferTextureLayer(int target, int attachment,
        ...
        GLES30.glFramebufferTextureLayer(target, attachment,
                texture, level, layer);
    }

// @Override
// public java.nio.Buffer glMapBufferRange(int target, int offset,
...
// int bufsize, int[] length, int lengthOffset, int[] size, int
...
// @Override
// public void glGetTransformFeedbackVarying(int program, int index,
// int bufsize, java.nio.IntBuffer length, java.nio.IntBuffer
...
// int lengthOffset, int[] binaryFormat, int
...
// int[] attachments, int offset, int x, int y, int width,
// int height) {
...
// }
    ...
    @Override
    public void glInvalidateSubFramebuffer(int target, int numAttachments,
                                           java.nio.IntBuffer attachments, int x, int y,
                                           int width, int height) {
        GLES30.glInvalidateSubFramebuffer(target, numAttachments,
...
// GLES30.glGetInternalformativ(target, internalformat, pname,
// bufSize, params, offset);
// }
//
// @Override
// public void glGetInternalformativ(int target, int internalformat,
