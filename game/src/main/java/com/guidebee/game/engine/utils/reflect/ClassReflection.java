 ...
 ******************************************************************************/
//--------------------------------- PACKAGE ------------------------------------
package com.guidebee.game.engine.utils.reflect;
...
public final class ClassReflection {
    ...
    /**
     * Determines if the supplied Object is assignment-compatible with the
     * object represented by supplied Class.
     */
    ...
    /**
     * Determines if the class or interface represented by first Class
     * parameter is either the same as, or is a superclass or
    ...
    /**
     * Returns true if the class or interface represented by the supplied
    ...
    static public <T> T newInstance(Class<T> c) throws ReflectionException {
        try {
            ...
            throw new ReflectionException("Could not instantiate instance of class: "
                    + c.getName(), e);
    ...
    /**
     * Returns a {@link Constructor} that represents the public constructor
     * for the supplied class which takes the supplied
     * parameter types.
     */
     ...
     * supplied class which takes the supplied parameter
     * types.
     */
    static public Constructor getDeclaredConstructor(Class c, Class... parameterTypes)
        ...
        try {
            ...
            throw new ReflectionException("Security violation while getting constructor for class: "
                    + c.getName(), e);
        } catch (NoSuchMethodException e) {
            throw new ReflectionException("Constructor not found for class: "
                    + c.getName(), e);
    ...
    /**
     * Returns a {@link Method} that represents the public member method for
     * the supplied class which takes the supplied parameter
     * types.
     */
    static public Method getMethod(Class c, String name, Class... parameterTypes)
        ...
        try {
            ...
            throw new ReflectionException("Security violation while getting method: "
                    + name + ", for class: " + c.getName(), e);
        } catch (NoSuchMethodException e) {
    ...
    /**
     * Returns an array of {@link Method} containing the methods declared
     * by the class represented by the supplied Class.
     */
    ...
    /**
     * Returns a {@link Method} that represents the method declared by
    ...
    /**
     * Returns an array of {@link Field} containing the public fields
     * of the class represented by the supplied Class.
     */
    ...
    /**
     * Returns a {@link Field} that represents the specified public
     * member field for the supplied class.
     */
    static public Field getField(Class c, String name)
        ...
        try {
            ...
            throw new ReflectionException("Security violation while getting field: "
                    + name + ", for class: " + c.getName(), e);
        } catch (NoSuchFieldException e) {
            throw new ReflectionException("Field not found: " + name + ", for class: "
                    + c.getName(), e);
        }
    }

    /**
     * Returns an array of {@link Field} objects reflecting all the
     * fields declared by the supplied class.
     */
    ...
    /**
     * Returns a {@link Field} that represents the specified declared
     * field for the supplied class.
     */
