 ...
 * (Apache license 2.0) -
 * http://www.apache.org/licenses/LICENSE-2.0 For more information on the
 * Apache Software Foundation, please see
 * <http://www.apache.org/>.
 * <p/>
 * Contains information about the HTTP status line returned with the
 * {@link com.guidebee.game.Net.HttpResponse} after
 * a {@link com.guidebee.game.Net.HttpRequest} was
 * performed. Also contains constants enumerating the HTTP Status Codes.
 * All status codes defined in RFC1945 (HTTP/1.0), RFC2616
...
public class HttpStatus {
    ...
    /**
     * Returns the status code of the HTTP response, normally 2xx status
     * codes indicate success while 4xx and 5xx indicate client
     * and server errors, respectively
     * (see <a href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html">HTTP/1.1:
     * Status Code
	...
	/*
     * Constants enumerating the HTTP status codes. All status codes
     * defined in RFC1945 (HTTP/1.0), RFC2616 (HTTP/1.1), and RFC2518
	 * (WebDAV) are listed.
	 */
    ...
    /**
     * Static constant for a 420 error. <tt>420 Method Failure</tt>
