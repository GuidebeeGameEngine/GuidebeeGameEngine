 ...
 * {@link Socket} instances. The {@link #accept(SocketHints)}
...
public interface ServerSocket extends Disposable {
    ...
    /**
     * Accepts a new incoming connection from a client {@link Socket}.
     ...
     *              {@link Socket}. IInput null to use the default setting
     *              provided by the system.
     * @return the accepted {@link Socket}
     * @throws com.guidebee.game.GameEngineRuntimeException in
