...
public class InputProcessorQueue implements InputProcessor {
    ...
    public synchronized boolean touchDown(int screenX, int screenY,
    ...
    public synchronized boolean touchUp(int screenX, int screenY,
                                        int pointer, int button) {
        queueTime();
        queue.add(TOUCH_UP);
        queue.add(screenX);
    ...
    public synchronized boolean touchDragged(int screenX, int
            screenY, int pointer) {
        queueTime();
