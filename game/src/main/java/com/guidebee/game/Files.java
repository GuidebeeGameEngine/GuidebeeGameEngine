...
/**
 * Provides standard access to the filesystem, classpath, Android SD card,
 * and Android assets directory.
 *
 * @author mzechner
 * @author Nathan Sweet
 */
public interface Files {
     ...
     * @throws GameEngineRuntimeException if the
     *        type is classpath or internal and the file does not exist.
     * @see FileType
     */
     ...
     * Android and the home directory of the current user on
     * the desktop.
     */
     ...
     * the SD card is not available when mounted for use
     * with a PC.
     */
     ...
     * directory on Android and the directory of the jar on the
     * desktop.
     */
    ...
    public enum FileType {
         ...
         * readonly. Note that classpath files are not
         * compatible with some functionality on Android, such as
         ...
         * root directory on the desktop. On the desktop,
         * if the file is not found, then the classpath is checked. This enables
         * files to be found when using JWS or applets.
         ...
         * portability across platforms use absolute files only
         * when absolutely (heh) necessary.
         */
        Absolute,

        /**
         * Path relative to the private files directory on Android and
         * to the application's root directory on the desktop.
         */
        Local;
    }
}
