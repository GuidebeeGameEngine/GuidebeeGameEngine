...
/**
 * A FileHandle intended to be sub classed for the purpose of implementing
 * {@link #read()} and/or {@link #write(boolean)}. Methods
...
public abstract class FileHandleStream extends FileHandle {
    /**
     * Create an {@link com.guidebee.game.Files.FileType#Absolute} file
