...
import com.guidebee.math.GeometryUtils;
...
public class Polygon {
     ...
     *
     * @param vertices an array where every even element represents
     *                 the horizontal part of a point, and the following element
     ...
     * rotation, and positional translations have been applied,
     ...
     *
     * @param vertices float array where every even element represents
     *                 the x-coordinate of a vertex, and the proceeding element
