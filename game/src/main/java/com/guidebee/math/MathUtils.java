...
public final class MathUtils {
    ...
    static private class Sin {
        ...
        static {
            ...
            for (int i = 0; i < 360; i += 90)
                table[(int) (i * degToIndex) & SIN_MASK]
                        = (float) Math.sin(i * degreesToRadians);
        }
    }
    ...
    /**
     * Returns the next power of two. Returns the specified
     * value if the value is already a power of two.
     */
     ...
     * float. This method will only properly floor floats from
    ...
    /**
     * Returns the largest integer less than or equal to the specified
     * float. This method will only properly floor floats that are
     ...
     * This method will only properly ceil floats from
     * -(2^14) to (Float.MAX_VALUE - 2^14).
     */
    ...
    /**
     * Returns the smallest integer greater than or equal to the specified float.
     * This method will only properly ceil floats that
     * are positive.
     */
    ...
    /**
     * Returns the closest integer to the specified float. This method will
     * only properly round floats from -(2^14) to
    ...
    /**
     * Returns the closest integer to the specified float. This method will
     * only properly round floats that are positive.
     */
     ...
     *
     * @param tolerance represent an upper bound below which the value
     *                  is considered zero.
     */
    ...
    /**
     * Returns true if a is nearly equal to b. The function uses the
     * default floating error tolerance.
     *
     ...
     * @param a         the first value.
     * @param b         the second value.
     * @param tolerance represent an upper bound below which the
