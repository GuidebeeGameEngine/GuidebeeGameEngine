...
public final class GeometryUtils {
    static private final Vector2 tmp1 = new Vector2(),
            tmp2 = new Vector2(), tmp3 = new Vector2();

    /**
     * Computes the barycentric coordinates v,w for the specified
     * point in the triangle.
     * <p/>
     * If barycentric.x >= 0 && barycentric.y >= 0 && barycentric.x +
     * barycentric.y <= 1 then the point is inside the triangle.
     * <p/>
     * If vertices a,b,c have values aa,bb,cc then to get an interpolated
     * value at point p:
     * <p/>
     * <pre>
     ...
     */
    static public Vector2 toBarycoord(Vector2 p, Vector2 a, Vector2 b,
    ...
    static public boolean barycoordInsideTriangle(Vector2 barycentric) {
        return barycentric.x >= 0 && barycentric.y >= 0
                && barycentric.x + barycentric.y <= 1;
    }

    /**
     * Returns interpolated values given the barycentric coordinates of
     * a point in a triangle and the values at each vertex.
     *
     * @return interpolatedOut
     */
    static public Vector2 fromBarycoord(Vector2 barycentric, Vector2 a,
                                        Vector2 b, Vector2 c, Vector2 interpolatedOut) {
    ...
    /**
     * Returns an interpolated value given the barycentric coordinates of
     * a point in a triangle and the values at each vertex.
     *
     * @return interpolatedOut
     */
    ...
    /**
     * Returns the lowest positive root of the quadric equation given by
    ...
    static public boolean colinear(float x1, float y1, float x2,
    ...
    static public Vector2 triangleCentroid(float x1, float y1, float x2,
                                           float y2, float x3, float y3,
                                           Vector2 centroid) {
     ...
     */
    static public Vector2 triangleCircumcenter(float x1, float y1, float x2,
                                               float y2, float x3, float y3,
        ...
        det *= 2;
        float sqr1 = x1 * x1 + y1 * y1, sqr2 = x2 * x2 + y2 * y2,
                sqr3 = x3 * x3 + y3 * y3;
    ...
    static public float triangleArea(float x1, float y1, float x2,
                                     float y2, float x3, float y3) {
        return Math.abs((x1 - x3) * (y2 - y1) - (x1 - x2) * (y3 - y1)) * 0.5f;
    }

    static public Vector2 quadrilateralCentroid(float x1, float y1, float x2,
                                                float y2, float x3, float y3,
                                                float x4, float y4,
                                                Vector2 centroid) {
     ...
     */
    static public Vector2 polygonCentroid(float[] polygon, int offset,
