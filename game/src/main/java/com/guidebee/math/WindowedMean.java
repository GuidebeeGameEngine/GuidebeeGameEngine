 ...
 * certain window. the WindowedMean will only return a
 * value in case enough data has been sampled. After enough data has been
 * sampled the oldest sample will be replaced by the newest
...
public final class WindowedMean {
     ...
     * continuously get the mean and variance from. the class will
     * only return meaning full values if at least window_size values
     * have been added.
     *
    ...
    /**
     * clears this WindowedMean. The class will only return meaningful
     * values after enough data has been added again.
     */
    public void clear() {
        added_values = 0;
        last_value = 0;
    ...
    /**
     * adds a new sample to this mean. In case the window is full the
     * oldest value will be replaced by this new value.
     *
    ...
    /**
     * returns the mean of the samples added to this instance. Only
     * returns meaningful results when at least window_size samples
