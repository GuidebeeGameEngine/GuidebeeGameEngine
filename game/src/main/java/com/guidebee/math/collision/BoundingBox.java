 ...
 * maximum Vector. Additionally you can query for the
...
public class BoundingBox implements Serializable {
    ...
    public BoundingBox ext(BoundingBox a_bounds) {
        ...
        return this.set(min.set(min(min.x, a_bounds.min.x),
                        min(min.y, a_bounds.min.y), min(min.z, a_bounds.min.z)),
     ...
     * multiplying the 8 corner points and then calculating
