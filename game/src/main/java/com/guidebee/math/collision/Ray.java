 ...
 ******************************************************************************/
//--------------------------------- PACKAGE ------------------------------------
package com.guidebee.math.collision;
...
public class Ray implements Serializable {
     ...
     * @deprecated Use {@link #getEndPoint(Vector3, float)} instead. Returns
     * the endpoint given the distance. This is calculated as
    ...
    /**
     * Returns the endpoint given the distance. This is calculated as
     * startpoint + distance * direction.
     *
    ...
    /**
     * Multiplies the ray by the given matrix. Use this to transform a
     * ray into another coordinate system.
     *
