 ...
 * themselves to avoid garbage collection as much as
 * possible. Calling any of the methods will result in the reuse of the
...
public class Bresenham2 {
    ...
    /**
     * Returns a list of {@link GridPoint2} instances along the given
     ...
     * @return the list of points on the line at integer coordinates
     */
    public Array<GridPoint2> line(int startX, int startY, int endX,
                                  int endY) {
        pool.freeAll(points);
        points.clear();
    ...
    /**
     * Returns a list of {@link GridPoint2} instances along the
     * given line, at integer coordinates.
     *
     * @param startX the start x coordinate of the line
     * @param startY the start y coordinate of the line
     * @param endX   the end x coordinate of the line
