 ...
 * {@link #tick()} to update the values. The {@link #time} {@link com.guidebee.math.FloatCounter} provides access to the minimum, maximum, average,
...
public class PerformanceCounter {
    ...
    public void tick(final float delta) {
        if (!valid) {
            GameEngine.app.error("PerformanceCounter", "Invalid data, check if you called PerformanceCounter#stop()");
            return;
        }
