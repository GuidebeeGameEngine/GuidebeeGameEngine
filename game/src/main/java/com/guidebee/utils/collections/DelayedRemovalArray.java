 ...
 * {@link #end()} is called. This can allow code out of
 * your control to remove items without affecting iteration. Between begin
 * and end, most mutator methods will throw
 * IllegalStateException. Only {@link #removeIndex(int)},
 * {@link #removeValue(Object, boolean)}, and add methods are allowed.
 * <p>
 * Code using this class must not rely on items being removed immediately.
 * Consider using {@link SnapshotArray} if this is a
 * problem..
 *
 * @author Nathan Sweet
 */
