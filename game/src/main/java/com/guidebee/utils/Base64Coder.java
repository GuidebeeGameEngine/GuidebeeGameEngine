 ...
 * <p>
 * Project home page:
 * <a href="http://www.source-code.biz/base64coder/java/">
...
public class Base64Coder {
    ...
    /**
     * Encodes a byte array into Base64 format. No blanks or
     * line breaks are inserted in the output.
     *
     * @param in An array containing the data bytes to be encoded.
     ...
     * tabs and blanks. CR, LF, Tab and Space characters are
     * ignored in the input data. This method is compatible with
     ...
     * are allowed within the Base64 encoded input data.
     *
     * @param s A Base64 String to be decoded.
     * @return An array containing the decoded data bytes.
     * @throws IllegalArgumentException If the input is not valid Base64 encoded data.
